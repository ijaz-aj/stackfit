 ...
 *
 * **Nothing beside it mentions signing in either**, and that is a decision
 * rather than an omission. The captions used to warn that sign-in was handled
 * on the way through, which is the right thing to tell a stranger and the wrong
 * thing to tell a colleague: this is the front of an internal tool, everyone
 * reading it works here, and the password box appears once and then not again
 * for thirty days, which is the session length. The gate is unchanged —
 * `/scenarios` runs `requireAnalyst()` exactly as every other route does — it
 * simply is not what the front page is about.
 */
          ...
          <div className="flex flex-col gap-6">
            ...
            */}
            ...
            {/*
              ...
              The caption used to say "For named analysts. Sign-in is handled on
              the way through, not here." That was written for a stranger, and
              this page has no strangers: it is the front of an internal tool
              and everyone reading it works here. Warning a colleague that they
              will be asked to sign in is warning them about a password box they
              see once and then not again for thirty days, which is the session
              length. So the caption says what is through the door instead of
              what is in front of it. The door itself has not changed and is not
              hidden — `/scenarios` gates on `requireAnalyst()` exactly as it
              always has.
            */}
            <div className="mt-1 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-5">
              ...
              <p className="text-faint max-w-[34ch] text-xs leading-relaxed">
                Straight to the scenarios the team has already scoped.
              </p>
            </div>
          </div>
