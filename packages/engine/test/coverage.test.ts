...
function bundleOf(
  ...
  const costShape = {
    ...
    providerDeliveryOneTime: zero,
    providerOpsFteAnnual: zero,
    year1: zero,
  ...
  return {
    ...
    attribution: {
      ...
      providerDeliveryOneTime: zero,
      providerRunAnnual: zero,
      providerAdministrationAnnual: zero,
      providerMonitoringAnnual: zero,
      providerMonitoringFte: 0,
      providerMarginAnnual: zero,
      providerMarginYearOne: zero,
      providerMarginRate: null,
